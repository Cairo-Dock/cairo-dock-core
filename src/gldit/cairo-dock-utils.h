...
struct _GldiChildProcessManagerBackend {
	 ...
	 * This should also eventually call waitpid() or similar to clean up the child process if necessary.
	 *
	 ...
	 *@param env  an optional vector environment variable to set for the launched process in the format of "VAR=value"
	 */
