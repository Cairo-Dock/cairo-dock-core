...
*@param pSurface la surface a appliquer.
*/
#define cairo_dock_set_icon_surface(pIconContext, pSurface, pIcon) cairo_dock_set_icon_surface_full (pIconContext, pSurface, 1, 1, pIcon, NULL)
/**
...
#define CD_APPLET_GET_MY_DOCK_DATA(pDock) cairo_dock_get_dock_data (pDock, myApplet)

#define CD_APPLET_SET_MY_ICON_DATA(pIcon, pData) cairo_dock_set_icon_data (pIcon, myApplet, pData)
#define CD_APPLET_SET_MY_DOCK_DATA(pDock, pData) cairo_dock_set_dock_data (pDock, myApplet, pData)
