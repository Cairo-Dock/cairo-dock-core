...
int main (int argc, char** argv)
{
	...
	"- test evaporation animation\n"
	"- test drop indicator\n"
	"- test keyboard-indicator drawing (transition)\n"
	"- test reload root dock's config (icon size)\n"
	"- load views' config before launchers (my_fPanelRatio)\n"
	"- fix quick-info size/drawing/blurry\n"
	"- replace modal dialogs when dock unhide (or it will stay behind)\n"
